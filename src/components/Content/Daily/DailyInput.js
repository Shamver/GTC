...
const DailyInput = () => {
  ...
  return (
    <>
      ...
      <CustomInput type="text" placeholder={isDoneToday === 'Y' ? '오늘 출석체크를 완료하셨습니다.' : '여기에 한마디를 입력해주세요.'} maxLength={20} value={message} onChange={onChangeValue} disabled={isDoneToday === 'Y'} />
