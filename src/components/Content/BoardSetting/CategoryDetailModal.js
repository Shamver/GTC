...
const BoardDetailModal = () => {
  ...
  const {
    isBoardModalToggle, toggleCategoryModal, category, useFlagList,
  ...
  return (
    <Modal isOpen={isBoardModalToggle} toggle={toggleCategoryModal}>
      <ModalHeaderBack toggle={toggleCategoryModal}>카테고리 추가</ModalHeaderBack>
      <ModalBody>
        <InputGroupMb>
